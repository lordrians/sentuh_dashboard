                    ...
                    <ul class="nav-main">
                        ...
                        <li class="nav-main-item{{ request()->is('examples/*') ? ' open' : '' }}">
                            <a class="nav-main-link nav-main-link-submenu" data-toggle="submenu" aria-haspopup="true" aria-expanded="true" href="#">
                                ...
                                <span class="nav-main-link-name">Manajemen</span>
                            </a>
                            <ul class="nav-main-submenu">
                                ...
                                <li class="nav-main-item">
                                    <a class="nav-main-link{{ request()->is('examples/faq') ? ' active' : '' }}" href="/examples/faq">
                                        <span class="nav-main-link-name">FaQ</span>
                                    </a>
                                </li>
                                <li class="nav-main-item">
                                    <a class="nav-main-link{{ request()->is('examples/clients') ? ' active' : '' }}" href="/examples/clients">
